...
const About = () => {
  return (
    ...
    className='flex flex-col gap-3 sm:gap-5 items-center justify-center text-white bg-gradient-to-l from-gray-600 to-gray-800 py-4 sm:pb-10'>
        ...
        <p className='font-thin sm:text-xl mx-2 sm:w-[60%] text-center'>​Empowering Students Through Exam Preparation. We understand the stress and pressure students face leading up to exams. Finding relevant and organized study materials can be a time-consuming hassle. That's where MAK-STUDY comes in!</p>
        <NavLink to={"/about"}>
