...
const AboutDetails = () => {
    return (
        <div className='text-white bg-gradient-to-br from-indigo-900/40 via-gray-800 to-indigo-900'>
            <div className='px-[5%] py-6'>
                <h1 className='text-2xl sm:text-4xl font-bold'>About Us</h1>
                <div className='flex justify-between items-center flex-wrap-reverse text-sm sm:text-base sm:gap-20'>
                    {/* left */}
