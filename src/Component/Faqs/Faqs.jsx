...
const Faqs = () => {
    const faqs=[
        {
            Ques:`
            What subjects does MAK-Book cover? `,
            Ans:`This website provides study resources for a comprehensive range of subjects relevant to your MAKAUT University stream. Be sure to explore the "Subjects" section to find the specific topics you need`
        },
        {
