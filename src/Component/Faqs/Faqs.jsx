...
const Faqs = () => {
    ...
    return (
        <div
            className='bg-gradient-to-tr pt-6 from-indigo-900/50 via-gray-800 to-indigo-900 top-0 text-white py-10  p-2 sm:p-4 '>
            <h1 className='text-3xl sm:text-5xl p-4 sm:p-6 font-bold text-center'>Frequently Asked Questions</h1>
